...
suep-run  -c configs_mds -o output_mds_min50 --chunk-size 10000 --workers 8
suep-plot output_mds_min50 -o output_mds_min50/plots -c configs_mds -j 8

# ── variant: DBSCAN min cluster size = 10 (CSC/DT) -> output_mds_minpts10/
